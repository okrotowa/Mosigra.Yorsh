...
namespace Yorsh.Activities
{
	...
	public class ShareToFacebookActivity : Activity
	{
		...
		{
			var image = BitmapFactory.DecodeResource (this.Resources, Resource.Drawable.background);
...
//			var linkContent = new ShareLinkContent.Builder ()
//				.SetContentTitle ("Ёрш")
//				.SetContentDescription ("Мы сыграли в Ёрша. Победитель спит под столом :) #Ёрш #Мосигра")
//				.SetContentUrl (Android.Net.Uri.Parse ("http://www.mosigra.ru/Face/Show/ersh/"))
//				.JavaCast<ShareLinkContent.Builder> ()
//				.Build ();
//
//			if (canPresentShareDialog)
