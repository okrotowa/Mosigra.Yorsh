...
namespace Yorsh.Activities
{
    ...
    public class GameActivity : BaseActivity
    {
        ...
        {
            ShowDialogTask(taskDialog, currentPlayer).RunSynchronously();
        }
        ...
        void InitPlayers()
        {
            ...
            FindViewById<ImageView>(Resource.Id.playerInGameImage).SetImageBitmap(this.PlayerPhoto(player));
        ...
        protected override void OnActivityResult(int requestCode, Result resultCode, Intent data)
        {
            ...
            if (requestCode == 100) StartActivityForResult(typeof(ChoosePlayerActivity), 101);
            if (requestCode == 101)
            {
